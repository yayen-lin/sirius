\section{Exact Vector Join}\label{sec:technical-1:-exact}
...
The join returns one of the three reduction outcomes from Section~\ref{subsec:vector-join}, the $k$ nearest per probe row, the $k$ nearest pairs overall, or every pair within a threshold $\varepsilon$, and we express all three as Sirius operators.
